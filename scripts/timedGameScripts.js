// Initializing Game class instance for timed game mode
const gameGridObject = new Game(8 * 8, 'gameGrid', 'timed');
...
const observer = new MutationObserver(() => {
  if (gameGridObject.seconds == 121) {
    gameGridObject.timedOut();
  }
